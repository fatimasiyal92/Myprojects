...
```
You can replace cu101 with "cu{100,92}" or "cuda".
...
Most models can run inference (but not training) without GPU support. To use cudas, set `MODEL.DEVICE='cuda'` in the config.
</details>
