...
int main(int argc, char** argv) {
  ...
  // setup inputs
  auto data = BlobGetMutableTensor(workSpace.GetBlob("data"), caffe2::cuda);
  ...
  auto im_info =
      BlobGetMutableTensor(workSpace.GetBlob("im_info"), caffe2::cuda);
  ...
  caffe2::Tensor bbox(
      workSpace.GetBlob("bbox_nms")->Get<caffe2::Tensor>(), caffe2::cuda);
  caffe2::Tensor scores(
      workSpace.GetBlob("score_nms")->Get<caffe2::Tensor>(), caffe2::cuda);
  caffe2::Tensor labels(
      workSpace.GetBlob("class_nms")->Get<caffe2::Tensor>(), caffe2::cuda);
  caffe2::Tensor mask_probs(
      workSpace.GetBlob("mask_fcn_probs")->Get<caffe2::Tensor>(), caffe2::cuda);
