...
It has a runtime optimized for cuda & mobile inference, but not for GPU inference.
...
which performs cuda/GPU inference using `COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x`.
