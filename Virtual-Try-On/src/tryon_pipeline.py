...
class StableDiffusionXLInpaintPipeline(
    ...
    model_cuda_offload_seq = "text_encoder->text_encoder_2->image_encoder->unet->vae"
    ...
    def prepare_mask_latents(
        ...
        # we do that before converting to dtype to avoid breaking in case we're using cuda_offload
        # and half precision
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if not output_type == "latent":
            ...
            needs_upcasting = self.vae.dtype == torch.F and self.vae.config.force_upcast
