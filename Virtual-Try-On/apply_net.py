...
class DumpAction(InferenceAction):
    ...
    def execute_on_outputs(
        ...
        if outputs.has("scores"):
            result["scores"] = outputs.get("scores").cuda()
        if outputs.has("pred_boxes"):
            result["pred_boxes_XYXY"] = outputs.get("pred_boxes").tensor.cuda()
...
class ShowAction(InferenceAction):
    ...
    def postexecute(cls: type, context: Dict[str, Any]):
        pass
# python ./apply_net.py show ./configs/densepose_rcnn_R_50_FPN_s1x.yaml https://dl.fbaipublicfiles.com/densepose/densepose_rcnn_R_50_FPN_s1x/165712039/model_final_162be9.pkl /home/alin0222/DressCode/upper_body/images dp_segm -v --opts MODEL.DEVICE cuda
